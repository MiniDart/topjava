...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        if (!env.acceptsProfiles("jdbc")) jpaUtil.clear2ndLevelHibernateCache();
    }

    @Test
    public void create() throws Exception {
        User newUser = new User(null, "New", "new@gmail.com", "newPass", 1555, false, new Date(), EnumSet.of(Role.ROLE_USER,Role.ROLE_ADMIN));
