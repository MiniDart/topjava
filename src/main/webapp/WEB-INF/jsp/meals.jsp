...
<section>
    ...
    <form method="post" action="ajax/meals/filter" id="filterForm">
        <div class="form-group">
            <label for="startDate" class="control-label col-md-1"><spring:message code="meal.startDate"/>:</label>
            <div class="col-md-11"><input type="date" name="startDate" value="${param.startDate}" id="startDate"></div>
            <label for="endDate" class="control-label col-md-1"><spring:message code="meal.endDate"/>:</label>
            <div class="col-md-11"><input type="date" name="endDate" value="${param.endDate}" id="endDate"></div>
            <label for="startTime" class="control-label col-md-1"><spring:message code="meal.startTime"/>:</label>
            <div class="col-md-11"><input type="time" name="startTime" value="${param.startTime}" id="startTime"></div>
            <label for="endTime" class="control-label col-md-1"><spring:message code="meal.endTime"/>:</label>
            <div class="col-md-11"><input type="time" name="endTime" value="${param.endTime}" id="endTime"></div>
        </div>
        <div class="form-group">
    ...
    <hr>
    <button class="btn btn-default" id="add_meal"><spring:message code="meal.add"/></button>
    <hr>
